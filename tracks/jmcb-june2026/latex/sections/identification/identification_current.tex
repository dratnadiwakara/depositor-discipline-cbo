...
historical lending decisions and current economic conditions at adoption---and
is predetermined relative to the deposit dynamics we study.
...
divergence.  The ten-quarter pre-period begins in 2020Q3, a window
constrained by panel data availability and chosen to follow the COVID-19
disruption quarters (2020Q1--2020Q2) whose aggregate liquidity dislocations
would complicate interpretation of pre-trend estimates.
...
This evidence suggests that a large share of the cross-sectional variation
in treatment intensity is idiosyncratic to the accounting measurement rather
than explained by observable credit-quality proxies.  Although NPL and
allowance ratios carry statistically significant coefficients, the low
explanatory power implies these observables cannot be used to reliably predict
which banks will face large adjustments---a finding we interpret as
additional support for the exogeneity of cross-sectional treatment assignment,
though we cannot rule out residual correlation through channels not captured
by the observables in our sample.
