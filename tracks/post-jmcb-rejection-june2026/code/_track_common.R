# =============================================================================
# _track_common.R — post-jmcb-rejection-june2026 track additions
# Source AFTER code/_common.R.
# =============================================================================

TRACK_DIR <- here::here("tracks", "post-jmcb-rejection-june2026")
...
# Latest stamped file in a dir (e.g. latest_track_file("panel_smallbank"))
