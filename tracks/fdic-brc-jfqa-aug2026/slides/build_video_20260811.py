"""Build MP4 presentation video from presentation_script_20260811.md +
...
Adapted from FINN6213/week1/build_video_v5.py. Differences:
  ...
  - Only the 21 talk pages are rendered; backup slides (pages 22-27) and the
    Q&A appendix in the script are excluded.

Pipeline (idempotent; cached artifacts reused):
  1. Parse script -> 21 narration chunks (one per PDF page 1..21).
  ...
  5. Concat -> presentation_video_20260811.mp4.

Usage:
  python build_video_20260811.py                # full build
  python build_video_20260811.py --stage tts|png|mp4|concat
"""
...
SCRIPT = HERE / "presentation_script_20260811.md"
PDF = HERE / "build" / "main.pdf"
WORK = HERE / ".video"
AUDIO_DIR = WORK / "audio"
PNG_DIR = WORK / "png"
CLIP_DIR = WORK / "clips"
OUTPUT = HERE / "presentation_video_20260811.mp4"
...
N_PAGES = 21          # talk pages only; 22-27 are backup slides
LEAD_IN_SEC = 0.5
TRAIL_SEC = 1.5
