...
is in principle correlated with 2022--2023 macro conditions.  The
within-bank composition design does not require the modeling component
to be pure noise, only that it not differentially move uninsured
relative to insured deposits within the same bank and quarter through
any channel other than the disclosure.
