...
knowable to outsiders in advance.  Everyone knew the date; nobody
outside the bank knew the number.  If outsiders had known the number
early, depositor-facing outcomes would have started to diverge before
adoption, which I test for directly.
...
is in principle correlated with 2022--2023 macro conditions.
...
($p < 0.001$) two months later; a one-percentage-point higher
adjustment is associated with roughly 2.8~percent lower market
...
for the deposit tests, for two reasons.  The cohort is small: 192
publicly traded holding companies, against more than 4,000
