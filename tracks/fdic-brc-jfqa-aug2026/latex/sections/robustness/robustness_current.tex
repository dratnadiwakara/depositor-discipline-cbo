...
measures of that vulnerability, the characteristics that identified
run-prone banks in 2023 \citep{jiang2024monetary}, with log assets and
equity-to-assets included in every specification: unrealized
securities losses and the uninsured share of deposits one at a time,
then jointly with the brokered share and CRE concentration.
...
Column (4) repeats the exercise with the composite run-risk measure
of \citet{huberdeau2025adverse}, who summarize a bank's vulnerability
as the expected loss of its uninsured depositors: promised debt over
...
unrealized securities losses.  The composite fares no better than its
components: the specification still explains well under one percent
of the variation, and the coefficient is \emph{negative} ($-0.406$,
$p<0.01$): among observably similar banks, those more exposed to runs
disclosed, if anything, slightly smaller charges.  The treatment is
orthogonal to the measure that identifies which banks expanded
insured funding on contemporaneous risk during 2023.
