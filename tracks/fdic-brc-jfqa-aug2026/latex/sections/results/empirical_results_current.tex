...
brokered deposits, so the triple difference measures the
...
on request): what the banks bought was the insurance, not the
wholesale funding as such.
...
points ($p<0.05$; continuous $0.175$, $p<0.05$), but I report them
separately here because they are distinct contractual arrangements and
the aggregation is not required for the result.
